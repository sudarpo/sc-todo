      ...
      <div className={isCollapsed ? "collapse navbar-collapse" : "collapse navbar-collapse show"} id="navbarNav">
        <ul className="navbar-nav">
          <li className="nav-item active">
            <a className="nav-link" href="#allTasks" onClick={() => handleChangeMode("AllTasks")}>
              All Tasks <span className="sr-only">(current)</span>
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-link" href="#newTask" onClick={() => handleChangeMode("NewTask")}>
              New Task
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-link" href="#login" onClick={() => handleChangeMode("Login")}>
              Login
            </a>
          </li>
        </ul>
